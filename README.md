...
git clone https://github.com/zarishsphere/zs-svc-crm.git
cd zs-svc-crm
...
See [docs.zarishsphere.com/api/zs-svc-crm](https://docs.zarishsphere.com/api/zs-svc-crm) for the full OpenAPI 3.1 specification.
